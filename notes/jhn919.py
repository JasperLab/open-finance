def response():
    ...
    tickers = ['BNS.TO', 'BAM-A.TO', 'CM.TO', 'MFC.TO',
               'NA.TO', 'POW.TO', 'RY.TO', 'SLF.TO', 'TD.TO']
    close, pct_growth = load_data(tickers, close, pct_growth, pd.datetime(
        2011, 2, 16), pd.datetime(2017, 2, 16))
